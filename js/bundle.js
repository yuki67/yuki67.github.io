...
var Gredients = require("./gredients.js");
...
function shape() {
  return Gredients.circloid((function (i, j) {
                return +(Caml_int32.mod_(Caml_int32.imul(k[0], i), n[0]) === j);
              }), n[0]);
}
...
exports.k = k;
exports.shape = shape;
/* Gredients Not a pure module */

},{"./gredients.js":3,"bs-platform/lib/js/caml_int32.js":28}],2:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';
...
function shape() {
  return Gredients.circloid((function (_, _$1) {
                return /* true */1;
              }), n[0]);
}
...
},{"./gredients.js":3}],3:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';
...
var Shape = require("../shape_ocaml/shape.js");
var ListExt = require("../myExt/src/listExt.js");
var Vector2D = require("../shape_ocaml/vector2D.js");
var Caml_array = require("bs-platform/lib/js/caml_array.js");
var Pervasives = require("bs-platform/lib/js/pervasives.js");

function square_subtransform(f, n) {
  var gen = function (shape) {
    var match = Shape.dest_polygon(shape);
    var match$1;
    if (match) {
      var match$2 = match[1];
      if (match$2) {
    ...
    var p2 = match$1[1];
    var p0 = match$1[0];
    var p1 = Vector2D.$star$dot$dot(0.5, Vector2D.$plus$dot$dot(p0, p2));
    var p3 = Vector2D.$star$dot$dot(0.5, Vector2D.$plus$dot$dot(p0, p6));
    var p5 = Vector2D.$star$dot$dot(0.5, Vector2D.$plus$dot$dot(p2, p8));
    var p7 = Vector2D.$star$dot$dot(0.5, Vector2D.$plus$dot$dot(p6, p8));
...
function circloid(f, n) {
  var points = Shape.regular_polygon_array(Vector2D.mk(0.5, 0.5), n, 0.5);
  return /* ShapeList */Block.__(5, [List.map((function (param) {
                    return /* Line */Block.__(1, [
                              Caml_array.caml_array_get(points, param[0]),
                              Caml_array.caml_array_get(points, param[1])
                            ]);
                  }), List.filter((function (param) {
                          return Curry._2(f, param[0], param[1]);
                        }))(ListExt.all_pairs((function (x, y) {
                            return /* tuple */[
                                    x,
                                    y
                                  ];
                          }), ListExt.range(/* None */0, /* None */0, n), ListExt.range(/* None */0, /* None */0, n))))]);
}
...
},{"../myExt/src/listExt.js":6,"../shape_ocaml/shape.js":16,"../shape_ocaml/vector2D.js":17,"bs-platform/lib/js/block.js":19,"bs-platform/lib/js/caml_array.js":22,"bs-platform/lib/js/curry.js":40,"bs-platform/lib/js/list.js":45,"bs-platform/lib/js/pervasives.js":46}],4:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';
...
function shape() {
  return Gredients.square_subtransform((function (v) {
                return Vector2D.$star$dot$dot(d[0], v);
              }), n[0]);
}
...
},{"../shape_ocaml/vector2D.js":17,"./gredients.js":3}],5:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';
...
function shape() {
  var gen = function (shape) {
    var lst = Shape.dest_polygon(shape);
    var shapes = List.map((function (v) {
            return Shape.enlarge(v, d[0])(shape);
          }), lst);
    return (function (n) {
        try {
          return List.nth(shapes, n);
        }
        catch (exn){
          throw Shape.Iter_stop;
        }
  ...
  return /* Recursive */Block.__(4, [
            gen,
            Shape.regular_polygon(Vector2D.mk(0.5, 0.5), m[0], 0.5),
            n[0]
          ]);
}
...
},{"../shape_ocaml/shape.js":16,"../shape_ocaml/vector2D.js":17,"bs-platform/lib/js/block.js":19,"bs-platform/lib/js/list.js":45}],6:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';
...
function linspace(a, b, n) {
  var step = (b - a) / (n - 1 | 0);
  var ans = Caml_array.caml_make_vect(n, 0);
  var now = a;
  for(var i = 0 ,i_finish = n - 1 | 0; i <= i_finish; ++i){
    Caml_array.caml_array_set(ans, i, now);
    now += step;
  }
...
},{"bs-platform/lib/js/array.js":18,"bs-platform/lib/js/caml_array.js":22,"bs-platform/lib/js/caml_builtin_exceptions.js":23,"bs-platform/lib/js/curry.js":40,"bs-platform/lib/js/list.js":45,"bs-platform/lib/js/pervasives.js":46,"bs-platform/lib/js/string.js":48}],7:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';

var Curry = require("bs-platform/lib/js/curry.js");
var Shape = require("../shape_ocaml/shape.js");
var Drawer = require("../shape_ocaml/drawer.js");
var ListExt = require("../myExt/src/listExt.js");
var Vector2D = require("../shape_ocaml/vector2D.js");
...
function draw_line(ctx, s) {
  ...
  (ctx.beginPath(), f$1(ctx), f(ctx), ctx).stroke();
  return /* () */0;
}
...
function draw_polygon(ctx, s) {
  ...
  if (lst === /* [] */0) {
    ...
    var lst$prime = ListExt.map(to_int_pair, lst);
    var match = ListExt.hd(lst$prime);
    var b = match[1];
    var a = match[0];
    var f = function (param) {
      param.lineTo(a, b);
    ...
    (ctx.beginPath(), f$1(ctx), ListExt.iter((function (param) {
                ctx.lineTo(param[0], param[1]);
                return /* () */0;
              }), ListExt.tl(lst$prime)), f(ctx), ctx).stroke();
    return /* () */0;
  }
}
...
function init(ctx) {
  Drawer.add_drawer(/* POINT */0, (function (param) {
          return draw_point(ctx, param);
        }));
  Drawer.add_drawer(/* LINE */1, (function (param) {
          return draw_line(ctx, param);
        }));
  Drawer.add_drawer(/* POLYGON */2, (function (param) {
          return draw_polygon(ctx, param);
        }));
  return Drawer.add_drawer(/* CIRCLE */3, (function (param) {
...
},{"../myExt/src/listExt.js":6,"../shape_ocaml/drawer.js":15,"../shape_ocaml/shape.js":16,"../shape_ocaml/vector2D.js":17,"bs-platform/lib/js/curry.js":40,"bs-platform/lib/js/js_boolean.js":42}],8:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';
...
var JsNet = require("./jsNet.js");
var Shape = require("../shape_ocaml/shape.js");
var Drawer = require("../shape_ocaml/drawer.js");
var Vector2D = require("../shape_ocaml/vector2D.js");
var JsDiamond = require("./jsDiamond.js");
var Caml_array = require("bs-platform/lib/js/caml_array.js");
var HtmlCanvas = require("./htmlCanvas.js");
var JsCardioid = require("./jsCardioid.js");
var JsSierpinskiLow = require("./jsSierpinskiLow.js");
var JsSierpinskiHigh = require("./jsSierpinskiHigh.js");
...
function ignore2(_, _$1) {
  return /* () */0;
}

var exhibitions = /* array */[
  /* tuple */[
    ignore2,
    (function () {
        return /* ShapeList */Block.__(5, [/* [] */0]);
      }),
    (function () {
        return /* () */0;
      })
...
var match = Caml_array.caml_array_get(exhibitions, 0);

var match_000 = [match[0]];

var match_001 = [match[1]];

var match_002 = [match[2]];
...
function load_exhibition(n) {
  var match = Caml_array.caml_array_get(exhibitions, n);
  init[0] = match[0];
  shape[0] = match[1];
  wipe[0] = match[2];
  return /* () */0;
...
var canvas_size = [512.0];

var canvas = JsExt.Canvas[/* create */0](/* () */0);

var context = canvas.getContext("2d");

var enlarge_button = JsExt.Button[/* create */2](/* () */0);

var shrink_button = JsExt.Button[/* create */2](/* () */0);

var sel = JsExt.Select[/* create */0](/* () */0);

function refresh_canvas_size() {
  var partial_arg = canvas_size[0] | 0;
  var partial_arg$1 = JsExt.Canvas[/* set_width */1];
  var f = function (param) {
    return partial_arg$1(partial_arg, param);
  };
  return JsExt.Canvas[/* set_height */2](canvas_size[0] | 0, (Curry._1(f, canvas), canvas));
}

function redraw() {
  context.clearRect(0, 0, canvas_size[0] | 0, canvas_size[0] | 0);
  return Drawer.draw(Shape.move(Vector2D.mk(5.0, 5.0))(Shape.enlarge(Vector2D.mk(0.0, 0.0), canvas_size[0] - 10.0)(Curry._1(shape[0], /* () */0))));
}

function enlarge_canvas(r, _) {
  canvas_size[0] = canvas_size[0] * r;
...
JsExt.Canvas[/* set_height */2](canvas_size[0] | 0, (Curry._1(f, canvas), canvas));

var partial_arg$2 = JsExt.Button[/* set_text */0];

function f$1(param) {
  return partial_arg$2("enlarge", param);
}

JsExt.Button[/* set_onclick */1]((function (param) {
        return enlarge_canvas(1.1, param);
      }), (Curry._1(f$1, enlarge_button), enlarge_button));

var partial_arg$3 = JsExt.Button[/* set_text */0];

function f$2(param) {
  return partial_arg$3("shrink", param);
}

JsExt.Button[/* set_onclick */1]((function (param) {
        return enlarge_canvas(0.9, param);
      }), (Curry._1(f$2, shrink_button), shrink_button));

var partial_arg$4 = JsExt.Select[/* set_onchange */3];

function f$3(param) {
  return partial_arg$4((function () {
                Curry._1(wipe[0], /* () */0);
                load_exhibition(JsExt.Select[/* get_value */1](sel));
                Curry._2(init[0], canvas, redraw);
                return redraw(/* () */0);
              }), param);
}

var partial_arg$5 = JsExt.Select[/* add_option */2];

function f$4(param) {
  return partial_arg$5("Siepinski (higher)", 5, param);
}

var partial_arg$6 = JsExt.Select[/* add_option */2];

function f$5(param) {
  return partial_arg$6("Siepinski (3)", 4, param);
}

var partial_arg$7 = JsExt.Select[/* add_option */2];

function f$6(param) {
  return partial_arg$7("Cardioid", 3, param);
}

var partial_arg$8 = JsExt.Select[/* add_option */2];

function f$7(param) {
  return partial_arg$8("Net", 2, param);
}

var partial_arg$9 = JsExt.Select[/* add_option */2];

function f$8(param) {
  return partial_arg$9("Diamond", 1, param);
}
...
JsExt.Element[/* insertBefore */0](document.currentScript, enlarge_button);

JsExt.Element[/* insertBefore */0](document.currentScript, shrink_button);

JsExt.Element[/* insertBefore */0](document.currentScript, JsExt.Document[/* createElement */0]("br"));

JsExt.Element[/* insertBefore */0](document.currentScript, canvas);
...
exports.shape = shape;
exports.wipe = wipe;
exports.load_exhibition = load_exhibition;
...
},{"../shape_ocaml/drawer.js":15,"../shape_ocaml/shape.js":16,"../shape_ocaml/vector2D.js":17,"./htmlCanvas.js":7,"./jsCardioid.js":9,"./jsDiamond.js":10,"./jsExt.js":11,"./jsNet.js":12,"./jsSierpinskiHigh.js":13,"./jsSierpinskiLow.js":14,"bs-platform/lib/js/block.js":19,"bs-platform/lib/js/caml_array.js":22,"bs-platform/lib/js/curry.js":40}],9:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';

var Curry = require("bs-platform/lib/js/curry.js");
var JsExt = require("./jsExt.js");
var Cardioid = require("../gallery/cardioid.js");
...
var n_range = JsExt.Range[/* create */7](/* () */0);

var k_range = JsExt.Range[/* create */7](/* () */0);

var n_span = JsExt.Span[/* create */0](/* () */0);

var k_span = JsExt.Span[/* create */0](/* () */0);

var n_br = JsExt.Document[/* createElement */0]("br");

var k_br = JsExt.Document[/* createElement */0]("br");

function refresh() {
  Cardioid.n[0] = JsExt.Range[/* get_value */0](n_range) | 0;
  Cardioid.k[0] = JsExt.Range[/* get_value */0](k_range) | 0;
  var str_n = String(Cardioid.n[0]);
  var str_k = String(Cardioid.k[0]);
  JsExt.Span[/* set_text */1]("n: " + (String(str_n) + ""), n_span);
  return JsExt.Span[/* set_text */1]("n: " + (String(str_k) + ""), k_span);
}

function wipe() {
  JsExt.Range[/* hide */8](n_range);
  JsExt.Range[/* hide */8](k_range);
  JsExt.Span[/* hide */2](n_span);
  JsExt.Span[/* hide */2](k_span);
  JsExt.Element[/* hide */1](n_br);
  return JsExt.Element[/* hide */1](k_br);
}

function init(canvas, redraw) {
  var partial_arg = JsExt.Range[/* set_value */5];
  var f = function (param) {
    return partial_arg(60.0, param);
  };
  var partial_arg$1 = JsExt.Range[/* set_max */2];
  var f$1 = function (param) {
    return partial_arg$1(400.0, param);
  };
  var partial_arg$2 = JsExt.Range[/* set_step */4];
  var f$2 = function (param) {
    return partial_arg$2(10.0, param);
  };
  JsExt.Range[/* set_oninput */6]((function () {
          refresh(/* () */0);
          return Curry._1(redraw, /* () */0);
        }), (Curry._1(f$2, n_range), Curry._1(f$1, n_range), Curry._1(f, n_range), n_range));
  var partial_arg$3 = JsExt.Range[/* set_value */5];
  var f$3 = function (param) {
    return partial_arg$3(2.0, param);
  };
  var partial_arg$4 = JsExt.Range[/* set_min */3];
  var f$4 = function (param) {
    return partial_arg$4(2.0, param);
  };
  var partial_arg$5 = JsExt.Range[/* set_max */2];
  var f$5 = function (param) {
    return partial_arg$5(9.0, param);
  };
  JsExt.Range[/* set_oninput */6]((function () {
          refresh(/* () */0);
          return Curry._1(redraw, /* () */0);
        }), (Curry._1(f$5, k_range), Curry._1(f$4, k_range), Curry._1(f$3, k_range), k_range));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Range[/* show */9](n_range), n_range));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Span[/* show */3](n_span), n_span));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Element[/* show */2](n_br), n_br));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Range[/* show */9](k_range), k_range));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Span[/* show */3](k_span), k_span));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Element[/* show */2](k_br), k_br));
  return refresh(/* () */0);
}

var shape = Cardioid.shape;

exports.$pipe$pipe$great = $pipe$pipe$great;
exports.shape = shape;
exports.n_range = n_range;
exports.k_range = k_range;
exports.n_span = n_span;
exports.k_span = k_span;
exports.n_br = n_br;
exports.k_br = k_br;
exports.refresh = refresh;
exports.wipe = wipe;
exports.init = init;
/* n_range Not a pure module */

},{"../gallery/cardioid.js":1,"./jsExt.js":11,"bs-platform/lib/js/curry.js":40}],10:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';

var Curry = require("bs-platform/lib/js/curry.js");
var JsExt = require("./jsExt.js");
var Diamond = require("../gallery/diamond.js");
...
function refresh() {
  var k = JsExt.Range[/* get_value */0](n_range) | 0;
  var str = String(k);
  Diamond.n[0] = k;
  return JsExt.Span[/* set_text */1]("n: " + (String(str) + ""), n_span);
}

function wipe() {
  JsExt.Range[/* hide */8](n_range);
  JsExt.Span[/* hide */2](n_span);
  return JsExt.Element[/* hide */1](n_br);
}

function init(canvas, redraw) {
  var partial_arg = JsExt.Range[/* set_value */5];
  var f = function (param) {
    return partial_arg(16.0, param);
  };
  var partial_arg$1 = JsExt.Range[/* set_max */2];
  var f$1 = function (param) {
    return partial_arg$1(64.0, param);
  };
  JsExt.Range[/* set_oninput */6]((function () {
          refresh(/* () */0);
          return Curry._1(redraw, /* () */0);
        }), (Curry._1(f$1, n_range), Curry._1(f, n_range), n_range));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Range[/* show */9](n_range), n_range));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Span[/* show */3](n_span), n_span));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Element[/* show */2](n_br), n_br));
  return refresh(/* () */0);
...
},{"../gallery/diamond.js":2,"./jsExt.js":11,"bs-platform/lib/js/curry.js":40}],11:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';
...
function set_width(n, canvas) {
  canvas["width"] = String(n);
  return /* () */0;
}

function set_height(n, canvas) {
  canvas["height"] = String(n);
  return /* () */0;
}

function insertBefore$1(place, elem) {
  place["parentNode"].insertBefore(elem, place);
  return /* () */0;
}
...
},{"bs-platform/lib/js/block.js":19,"bs-platform/lib/js/caml_format.js":27,"bs-platform/lib/js/curry.js":40,"bs-platform/lib/js/js.js":41,"bs-platform/lib/js/js_primitive.js":44,"bs-platform/lib/js/printf.js":47}],12:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';

var Net = require("../gallery/net.js");
var Curry = require("bs-platform/lib/js/curry.js");
var JsExt = require("./jsExt.js");
var Pervasives = require("bs-platform/lib/js/pervasives.js");
...
var d_range = JsExt.Range[/* create */7](/* () */0);

var n_span = JsExt.Span[/* create */0](/* () */0);

var d_span = JsExt.Span[/* create */0](/* () */0);

var n_br = JsExt.Document[/* createElement */0]("br");

var d_br = JsExt.Document[/* createElement */0]("br");

function refresh() {
  var n$prime = JsExt.Range[/* get_value */0](n_range) | 0;
  var d$prime = JsExt.Range[/* get_value */0](d_range);
  Net.n[0] = n$prime;
  Net.d[0] = d$prime;
  var n_str = String(n$prime);
  var d_str = Pervasives.string_of_float(d$prime);
  JsExt.Span[/* set_text */1]("n: " + (String(n_str) + ""), n_span);
  return JsExt.Span[/* set_text */1]("d: " + (String(d_str) + ""), d_span);
}

function wipe() {
  JsExt.Range[/* hide */8](n_range);
  JsExt.Range[/* hide */8](d_range);
  JsExt.Span[/* hide */2](n_span);
  JsExt.Span[/* hide */2](d_span);
  JsExt.Element[/* hide */1](n_br);
  return JsExt.Element[/* hide */1](d_br);
}
...
function init(canvas, redraw) {
  ...
  var partial_arg$1 = JsExt.Range[/* set_max */2];
  var f$1 = function (param) {
    return partial_arg$1(8.0, param);
  };
  JsExt.Range[/* set_oninput */6]((function () {
          refresh(/* () */0);
          return Curry._1(redraw, /* () */0);
        }), (Curry._1(f$1, n_range), Curry._1(f, n_range), n_range));
  var partial_arg$2 = JsExt.Range[/* set_value */5];
  var f$2 = function (param) {
    return partial_arg$2(0.075, param);
  };
  var partial_arg$3 = JsExt.Range[/* set_step */4];
  var f$3 = function (param) {
    return partial_arg$3(0.025, param);
  };
  var partial_arg$4 = JsExt.Range[/* set_min */3];
  var f$4 = function (param) {
    return partial_arg$4(-0.25, param);
  };
  var partial_arg$5 = JsExt.Range[/* set_max */2];
  var f$5 = function (param) {
    return partial_arg$5(0.25, param);
  };
  JsExt.Range[/* set_oninput */6]((function () {
          refresh(/* () */0);
          return Curry._1(redraw, /* () */0);
        }), (Curry._1(f$5, d_range), Curry._1(f$4, d_range), Curry._1(f$3, d_range), Curry._1(f$2, d_range), d_range));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Range[/* show */9](n_range), n_range));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Span[/* show */3](n_span), n_span));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Element[/* show */2](n_br), n_br));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Range[/* show */9](d_range), d_range));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Span[/* show */3](d_span), d_span));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Element[/* show */2](d_br), d_br));
  return refresh(/* () */0);
}
...
exports.shape = shape;
exports.n_range = n_range;
exports.d_range = d_range;
exports.n_span = n_span;
exports.d_span = d_span;
exports.n_br = n_br;
exports.d_br = d_br;
exports.refresh = refresh;
exports.wipe = wipe;
...
},{"../gallery/net.js":4,"./jsExt.js":11,"bs-platform/lib/js/curry.js":40,"bs-platform/lib/js/pervasives.js":46}],13:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';
...
var JsExt = require("./jsExt.js");
var Pervasives = require("bs-platform/lib/js/pervasives.js");
var Sierpinski = require("../gallery/sierpinski.js");
...
var m_range = JsExt.Range[/* create */7](/* () */0);

var d_range = JsExt.Range[/* create */7](/* () */0);

var n_span = JsExt.Span[/* create */0](/* () */0);

var m_span = JsExt.Span[/* create */0](/* () */0);

var d_span = JsExt.Span[/* create */0](/* () */0);

var n_br = JsExt.Document[/* createElement */0]("br");

var m_br = JsExt.Document[/* createElement */0]("br");

var d_br = JsExt.Document[/* createElement */0]("br");

function refresh() {
  Sierpinski.n[0] = JsExt.Range[/* get_value */0](n_range) | 0;
  Sierpinski.m[0] = JsExt.Range[/* get_value */0](m_range) | 0;
  Sierpinski.d[0] = JsExt.Range[/* get_value */0](d_range);
  var str_n = String(Sierpinski.n[0]);
  var str_k = String(Sierpinski.m[0]);
  var str_d = Pervasives.string_of_float(Sierpinski.d[0]);
  JsExt.Span[/* set_text */1]("n: " + (String(str_n) + ""), n_span);
  JsExt.Span[/* set_text */1]("m: " + (String(str_k) + ""), m_span);
  return JsExt.Span[/* set_text */1]("d: " + (String(str_d) + ""), d_span);
}

function wipe() {
  JsExt.Range[/* hide */8](n_range);
  JsExt.Range[/* hide */8](m_range);
  JsExt.Range[/* hide */8](d_range);
  JsExt.Span[/* hide */2](n_span);
  JsExt.Span[/* hide */2](m_span);
  JsExt.Span[/* hide */2](d_span);
  JsExt.Element[/* hide */1](n_br);
  JsExt.Element[/* hide */1](m_br);
  return JsExt.Element[/* hide */1](d_br);
}
...
function init(canvas, redraw) {
  ...
  var partial_arg$1 = JsExt.Range[/* set_step */4];
  var f$1 = function (param) {
    return partial_arg$1(1.0, param);
  };
  var partial_arg$2 = JsExt.Range[/* set_max */2];
  var f$2 = function (param) {
    return partial_arg$2(2.0, param);
  };
  var partial_arg$3 = JsExt.Range[/* set_min */3];
  var f$3 = function (param) {
    return partial_arg$3(1.0, param);
  };
  JsExt.Range[/* set_oninput */6]((function () {
          refresh(/* () */0);
          return Curry._1(redraw, /* () */0);
        }), (Curry._1(f$3, n_range), Curry._1(f$2, n_range), Curry._1(f$1, n_range), Curry._1(f, n_range), n_range));
  var partial_arg$4 = JsExt.Range[/* set_value */5];
  var f$4 = function (param) {
    return partial_arg$4(3.0, param);
  };
  var partial_arg$5 = JsExt.Range[/* set_step */4];
  var f$5 = function (param) {
    return partial_arg$5(1.0, param);
  };
  var partial_arg$6 = JsExt.Range[/* set_max */2];
  var f$6 = function (param) {
    return partial_arg$6(32.0, param);
  };
  var partial_arg$7 = JsExt.Range[/* set_min */3];
  var f$7 = function (param) {
    return partial_arg$7(3.0, param);
  };
  JsExt.Range[/* set_oninput */6]((function () {
          refresh(/* () */0);
          return Curry._1(redraw, /* () */0);
        }), (Curry._1(f$7, m_range), Curry._1(f$6, m_range), Curry._1(f$5, m_range), Curry._1(f$4, m_range), m_range));
  var partial_arg$8 = JsExt.Range[/* set_value */5];
  var f$8 = function (param) {
    return partial_arg$8(0.5, param);
  };
  var partial_arg$9 = JsExt.Range[/* set_step */4];
  var f$9 = function (param) {
    return partial_arg$9(0.025, param);
  };
  var partial_arg$10 = JsExt.Range[/* set_max */2];
  var f$10 = function (param) {
    return partial_arg$10(1.0, param);
  };
  var partial_arg$11 = JsExt.Range[/* set_min */3];
  var f$11 = function (param) {
    return partial_arg$11(0.0, param);
  };
  JsExt.Range[/* set_oninput */6]((function () {
          refresh(/* () */0);
          return Curry._1(redraw, /* () */0);
        }), (Curry._1(f$11, d_range), Curry._1(f$10, d_range), Curry._1(f$9, d_range), Curry._1(f$8, d_range), d_range));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Range[/* show */9](n_range), n_range));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Span[/* show */3](n_span), n_span));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Element[/* show */2](n_br), n_br));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Range[/* show */9](m_range), m_range));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Span[/* show */3](m_span), m_span));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Element[/* show */2](m_br), m_br));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Range[/* show */9](d_range), d_range));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Span[/* show */3](d_span), d_span));
  JsExt.Canvas[/* insertBefore */3](canvas, (JsExt.Element[/* show */2](d_br), d_br));
  return refresh(/* () */0);
...
var shape = Sierpinski.shape;

exports.$pipe$pipe$great = $pipe$pipe$great;
exports.shape = shape;
exports.n_range = n_range;
exports.m_range = m_range;
exports.d_range = d_range;
exports.n_span = n_span;
exports.m_span = m_span;
exports.d_span = d_span;
exports.n_br = n_br;
exports.m_br = m_br;
exports.d_br = d_br;
...
},{"../gallery/sierpinski.js":5,"./jsExt.js":11,"bs-platform/lib/js/curry.js":40,"bs-platform/lib/js/pervasives.js":46}],14:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';
...
function refresh() {
  Sierpinski.n[0] = JsExt.Range[/* get_value */0](n_range) | 0;
  var str_n = String(Sierpinski.n[0]);
  return JsExt.Span[/* set_text */1]("n: " + (String(str_n) + ""), n_span);
}
...
function init(canvas, redraw) {
  ...
  var partial_arg$2 = JsExt.Range[/* set_max */2];
  var f$2 = function (param) {
    return partial_arg$2(8.0, param);
  };
  var partial_arg$3 = JsExt.Range[/* set_min */3];
  var f$3 = function (param) {
    return partial_arg$3(1.0, param);
...
},{"../gallery/sierpinski.js":5,"./jsExt.js":11,"bs-platform/lib/js/curry.js":40}],15:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';
...
function draw(shape) {
  switch (shape.tag | 0) {
    case 0 : 
        var shape$1 = shape;
        var match = List.assoc(/* POINT */0, drawer_alist[0]);
        if (match) {
          return Curry._1(match[0], shape$1);
        } else {
          return Pervasives.failwith("No way to draw a shape!");
        }
    case 1 : 
        var shape$2 = shape;
        var match$1 = List.assoc(/* LINE */1, drawer_alist[0]);
        if (match$1) {
          return Curry._1(match$1[0], shape$2);
        } else {
          var match$2 = Shape.dest_line(shape$2);
          var q = match$2[1];
          var p = match$2[0];
          var ts = ListExt.linspace(0.0, 1.0, 50);
          var points = List.map((function (r) {
                  return /* Point */Block.__(0, [Vector2D.lerp(p, q, r)]);
                }), ts);
          return List.iter(draw, points);
        }
    case 2 : 
        var shape$3 = shape;
        var match$3 = List.assoc(/* POLYGON */2, drawer_alist[0]);
        if (match$3) {
          return Curry._1(match$3[0], shape$3);
        } else {
          var lst = Shape.dest_polygon(shape$3);
          ...
          return List.iter(draw, lines);
        }
    case 3 : 
        var shape$4 = shape;
        var match$4 = List.assoc(/* CIRCLE */3, drawer_alist[0]);
        if (match$4) {
          return Curry._1(match$4[0], shape$4);
        } else {
          var match$5 = Shape.dest_circle(shape$4);
          var r = match$5[1];
          var p$1 = match$5[0];
          var points$1 = List.map((function (param) {
                  return Vector2D.$plus$dot$dot(p$1, param);
                }), List.map((function (param) {
                      return Vector2D.mk_polar(r, param);
                    }), ListExt.linspace(0.0, 2.0 * Shape.pi, 35)));
          return draw(/* Polygon */Block.__(2, [points$1]));
        }
    case 4 : 
        var shape$5 = shape;
        var match$6 = Shape.dest_recursive(shape$5);
        var gen = match$6[0];
...
},{"../myExt/src/listExt.js":6,"./shape.js":16,"./vector2D.js":17,"bs-platform/lib/js/block.js":19,"bs-platform/lib/js/curry.js":40,"bs-platform/lib/js/list.js":45,"bs-platform/lib/js/pervasives.js":46}],16:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';
...
function regular_polygon(center, n, r) {
  ...
  var points = List.map((function (theta) {
  ...
  return /* Polygon */Block.__(2, [points]);
}

function regular_polygon_array(center, n, r) {
  var offset = 3.0 * 3.14159265358979312 / n + 0.5 * 3.14159265358979312;
  return $$Array.map((function (theta) {
                return Vector2D.$plus$dot$dot(center, Vector2D.mk_polar(r, theta - offset));
              }), $$Array.of_list(ListExt.take(ListExt.linspace(0.0, 2.0 * 3.14159265358979312, n + 1 | 0), n)));
}
...
exports.regular_polygon_array = regular_polygon_array;
exports.map_on_points = map_on_points;
exports.enlarge = enlarge;
exports.move = move;
/* Vector2D Not a pure module */

},{"../myExt/src/listExt.js":6,"./vector2D.js":17,"bs-platform/lib/js/array.js":18,"bs-platform/lib/js/block.js":19,"bs-platform/lib/js/caml_exceptions.js":25,"bs-platform/lib/js/curry.js":40,"bs-platform/lib/js/list.js":45,"bs-platform/lib/js/pervasives.js":46}],17:[function(require,module,exports){
// Generated by BUCKLESCRIPT VERSION 2.2.3, PLEASE EDIT WITH CARE
'use strict';
...
},{"bs-platform/lib/js/caml_format.js":27,"bs-platform/lib/js/caml_obj.js":32,"bs-platform/lib/js/pervasives.js":46}],18:[function(require,module,exports){
'use strict';
...
},{"./caml_array.js":22,"./caml_builtin_exceptions.js":23,"./caml_exceptions.js":25,"./curry.js":40,"./js_exn.js":43}],19:[function(require,module,exports){
'use strict';
...
},{"./bytes.js":21,"./caml_builtin_exceptions.js":23,"./caml_string.js":34,"./curry.js":40,"./pervasives.js":46,"./string.js":48}],21:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":23,"./caml_int32.js":28,"./caml_obj.js":32,"./caml_primitive.js":33,"./caml_string.js":34,"./char.js":39,"./curry.js":40,"./list.js":45}],22:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":23}],23:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":23}],25:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":23,"./caml_int32.js":28,"./caml_int64.js":29,"./caml_utils.js":36,"./curry.js":40}],28:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":23}],29:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":23,"./caml_int32.js":28,"./caml_primitive.js":33,"./caml_utils.js":36}],30:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./caml_builtin_exceptions.js":23,"./curry.js":40,"_process":49}],31:[function(require,module,exports){
'use strict';
...
},{"./block.js":19,"./caml_builtin_exceptions.js":23,"./caml_primitive.js":33}],33:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":23}],35:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./caml_builtin_exceptions.js":23,"_process":49}],36:[function(require,module,exports){
'use strict';
...
},{"./block.js":19,"./buffer.js":20,"./bytes.js":21,"./caml_builtin_exceptions.js":23,"./caml_bytes.js":24,"./caml_exceptions.js":25,"./caml_float.js":26,"./caml_format.js":27,"./caml_int32.js":28,"./caml_io.js":30,"./caml_obj.js":32,"./caml_primitive.js":33,"./caml_string.js":34,"./camlinternalFormatBasics.js":38,"./char.js":39,"./curry.js":40,"./js_exn.js":43,"./pervasives.js":46,"./string.js":48}],38:[function(require,module,exports){
'use strict';
...
},{"./block.js":19}],39:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":23,"./caml_string.js":34}],40:[function(require,module,exports){
'use strict';
...
},{"./caml_array.js":22}],41:[function(require,module,exports){
'use strict';
...
},{"./caml_exceptions.js":25}],44:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":23,"./caml_obj.js":32,"./curry.js":40,"./pervasives.js":46}],46:[function(require,module,exports){
'use strict';
...
},{"./caml_builtin_exceptions.js":23,"./caml_exceptions.js":25,"./caml_format.js":27,"./caml_io.js":30,"./caml_missing_polyfill.js":31,"./caml_string.js":34,"./caml_sys.js":35,"./camlinternalFormatBasics.js":38,"./curry.js":40}],47:[function(require,module,exports){
'use strict';
...
},{"./buffer.js":20,"./camlinternalFormat.js":37,"./curry.js":40,"./pervasives.js":46}],48:[function(require,module,exports){
'use strict';
...
},{"./bytes.js":21,"./caml_int32.js":28,"./caml_primitive.js":33,"./caml_string.js":34,"./list.js":45}],49:[function(require,module,exports){
